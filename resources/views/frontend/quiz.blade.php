                        ...
                        <div class="col-lg-12 details-post">
                            <div class="single-news">
                                ...
                                <div class="quiz-container">
                                    @php
                                        $totalquiz = count($data->tquizs);
                                    @endphp
                                    <input type="hidden" id="totalQuizz" value="{{$totalquiz}}">
                                        ...
                                        <div class="quiz-question">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="image">
                                                    <img src="{{asset('assets/images/quiz/'.$quiz->question_photo)}}" alt="" >
                                                    </div>
                                                    <div class="question-answers">
                                                        @foreach ($quiz->answers as $answer)
                                                            @if ($answer->answer_photo)
                                                                <div class="card float-left mr-2 overflow-hidden" style="width: 10rem;">
                                                                    <img src="{{asset('assets/images/quizanswer/'.$answer->answer_photo)}}" class="card-img-top" alt="...">
                                                                    <div class="card-body">
                                                                        <div class="single-answer question-{{$quiz->id}}" id="question-{{$quiz->id}}" data-question_id="{{$quiz->id}}" data-answer_id="{{$answer->id}}" data-assign-value="{{$answer->correct_answer}}" data-card="yes">
                                                                            <div class="radio">
                                                            ...
                                                            @else 
                                                                <div class="single-answer question-{{$quiz->id}} overflow-hidden" id="question-{{$quiz->id}}" data-question_id="{{$quiz->id}}" data-answer_id="{{$answer->id}}" data-assign-value="{{$answer->correct_answer}}">
                                                                    <div class="radio">
                                                                        <i class="far fa-circle" id="correctCircle"></i>
                                                                    </div>
                                                                    <div class="text">
                                                    ...
                                                    <div class="col-sm-12 overflow-hidden">
                                                        <h6 class="alert alert-success correct-result mt-4" role="alert" style="display:none">
                                                            <i class="fas fa-check mr-2"></i>{{__('Correct Answer')}}
                                                        </h6>
                                                        <h6 class="alert alert-danger wrong-result mt-4" role="alert" style="display:none">
                                ...
                                <div class="quiz-result">
                                    <div class="row">
                                        @foreach ($data->tresults as $result)
                                            <div class="col-sm-12 tresult result-{{$result->id}}" data-result="{{$result->id}}" data-min="{{$result->min}}" data-max="{{$result->max}}" style="display:none">
                                                <h4 class="title m-2">
                                                    {{$result->result_title}}
                                                </h4>
                                                <div class="description font-text"></div>
                                                <div class="image">
                                                    <img src="{{asset('assets/images/quizresult/'.$result->result_photo)}}" alt="" >
                                                </div>
...
@push('js')
<script src="{{asset('assets/front/js/quiz.js')}}"></script>
@endpush
