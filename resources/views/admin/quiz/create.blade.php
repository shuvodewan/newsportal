...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Add Quiz') }}</h4>
                <ul class="links">
                    <li>
    ...
    <form id="tquizformdata" action="{{ route('tquiz.store')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
                    ...
                    <div id="headingOne" class="iub">
                        <div class="btn d-flex justify-content-between bg-light">
                            ...
                            <div class="right align-self-center">
                                ...
                                data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="collapsebutton btn btn-info" data-id="plus"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="product-description">
                                <div class="body-area p-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text" class="input-field" name='question_title[]' placeholder="{{ __('Question') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row question_description">
                                                ...
                                                <div class="col-lg-12">
                                                    <textarea class="nic-edit" name="question_description" placeholder="{{__('Description')}}" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="card-body py-3 border">
                                                            <div class="img-upload custom-image-upload">
                                                                <div id="image-preview" class="img-preview"
                                                                    ...
                                                                    <input type="file" name="answer_photo[1][1]" class="img-upload" id="image-upload" required>
                                                                </div>
                                                            </div>
                                                            <input type="text" class="input-field mt-3" name="answer_title[1][1]" placeholder="{{ __('Answer Text') }}" autocomplete="off" required>
                                                            <div class="correct-ans mt-2">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" id="customRadio1" name="correct_answer[1]" value="1" class="custom-control-input req_question" checked required>
                                                                    <label class="custom-control-label" for="customRadio1">{{__('Correct')}}</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xl-4 col-6 quiz-single-div">
                                                    <div class="card single-answer">
                                                        <div class="card-body py-3 border">
                                                            ...
                                                            <div class="correct-ans mt-2">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" id="customRadio2" name="correct_answer[1]" value="2" class="custom-control-input req_question" required>
                                                                    <label class="custom-control-label" for="customRadio2">{{__('Correct')}}</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="product-description">
                                <div class="body-area p-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text" name="result_title[]" class="input-field" placeholder="{{ __('Result') }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="number" name="min[]" class="input-field" placeholder="{{ __('Min') }}" min="0">
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="number" name="max[]" class="input-field" placeholder="{{ __('Max') }}" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="product-description">
                                <div class="body-area">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="submit" data-draft="1" class="btn btn-warning tquiz-btn1 saveAsDraft" value="Save as Drafts">
                                            <input type="submit" data-draft="0" class="btn btn-success tquiz-btn1 addPost" value="Add Post">
                                        </div>
                                    </div>
                                </div>
                            </div>
