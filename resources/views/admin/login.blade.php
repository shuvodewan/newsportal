            ...
            <div class="login-area">
              ...
              <form id="loginform" action="{{ route('admin.login') }}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="email" name="email" class="User Name" placeholder="{{ __('Type Email Address') }}" value="" autofocus>
                    <i class="icofont-user-alt-5"></i>
                  </div>
                  <div class="form-input">
                    <input type="password" name="password" value="" class="Password" placeholder="{{ __('Type Password') }}">
