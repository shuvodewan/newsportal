...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Edit Personality Quiz') }}</h4>
                <ul class="links">
                    <li>
    ...
    <form id="personalityformdata" action="{{route('pquiz.update',$data->id)}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="quiz_edit_result">
                @foreach ($data->presults as $presult)
                <input type="hidden" name="presult_id[]" value="{{$presult->id}}">
                                    ...
                                    <div id="heading{{$loop->iteration}}">
                                        <div class="btn d-flex justify-content-between bg-light">
                                            <div class="left header-part">
                                                #<span class="result_serial_no">{{$loop->iteration}}</span><span class="result_title ml-2">{{$presult->result_title}}</span>
                                            </div>
                                            <div class="right">
                                                ...
                                                @if (!$loop->first)
                                                    <span class="btn btn-danger btn-sm">
                                                        <i class="fas fa-trash remove_pquiz_result_edit" data-p_result_edit="{{$presult->id}}"></i>
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
                                                ...
                                                <div class="body-area p-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 input-area">
                                                            <input type="text" name="result_title[]" value="{{$presult->result_title}}" class="input-field" id="get_result_title" placeholder="{{ __('Result') }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="img-upload custom-image-upload">
                                                                        <div id="image-preview" class="img-preview"
                                                                            style="background: url({{ $presult->result_photo ? asset('assets/images/presult/'.$presult->result_photo) : asset('assets/admin/images/upload.png') }});">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="row result_description">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <textarea class="nic-edit" name="result_description" placeholder="Details">{{$presult->result_description}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <div class="add_edit_pquestion">
            @php
                $i=1;
            @endphp
            @foreach ($data->pquizs as $pquiz)
                @php
                    $j=1;
                @endphp
                <input type="hidden" name="question_id[]" value="{{$pquiz->id}}">
                                ...
                                <div id="heading-0" class="iub">
                                    <div class="btn d-flex justify-content-between bg-light">
                                        ...
                                        <div class="right align-self-center">
                                            <button type="button" data-toggle="collapse" data-target="#collapse{{$loop->iteration}}" aria-expanded="true" aria-controls="collapse{{$loop->iteration}}" class="collapsebutton btn btn-info" data-id="plus"><i class="fas fa-minus"></i></button>
                                            @if (!$loop->first)
                                                <span class="btn btn-danger btn-sm">
                                                    <i class="fas fa-trash remove_quiz_question_edit" data-p_quiz_qid="{{$pquiz->id}}"></i>
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="product-description">
                                            <div class="body-area p-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text" class="input-field" name="question_title[]" value="{{$pquiz->question_title}}" placeholder="{{ __('Question') }}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="img-upload custom-image-upload">
                                                                    <div id="image-preview" class="img-preview"
                                                                        style="background: url({{ $pquiz->question_photo ? asset('assets/images/pquiz/'.$pquiz->question_photo) : asset('assets/admin/images/upload.png') }});">
                                                                        <label for="image-upload" class="img-label" id="image-label">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="row question_description">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <textarea class="nic-edit" name="question_description" placeholder="Details">{{$pquiz->question_description}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row quiz-answer-area">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row" id="quiz-single-answer">
                                                            @foreach ($pquiz->answers as $key=>$answer)
                                                            <input type="hidden" name="answer_id[{{$i}}][{{$j}}]" value="{{$answer->id}}">
                                                                <div class="col-xl-4 col-6 quiz-single-div mt-2">
                                                                    <div class="card single-answer">
                                                                        @if (!($key==0 || $key==1))
                                                                            <div class="close">
                                                                                <i class="fa fa-times remove_button_edit" data-val="{{$answer->id}}"></i>
                                                                            </div>
                                                                        @endif
                                                                        <div class="card-body py-3 border">
                                                                            <div class="img-upload custom-image-upload">
                                                                                <div id="image-preview" class="img-preview"
                                                                                    style="background: url({{ $answer->answer_photo ? asset('assets/images/panswer/'.$answer->answer_photo) : asset('assets/admin/images/upload.png') }});">
                                                                                    <label for="image-upload" class="img-label"id="image-label">
                                                                                        <i class="icofont-upload-alt"></i>{{__('Upload')}}
                                                                                    </label>
                                                                            ...
                                                                            <div class="correct-ans mt-2">
                                                                                <div class="form-group">
                                                                                    <select class="form-control myColors" data-value="{{$answer->answer_option}}" name="answer_option[{{$i}}][{{$j}}]">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="submit" data-draft="0"
                                                    class="btn btn-success personality-btn1 addPost" value="Update Post">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="{{asset('assets/admin/js/pquiz_edit.js')}}"></script>
