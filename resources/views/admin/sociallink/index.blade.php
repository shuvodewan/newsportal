							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('social.link.index') }}">{{ __('Social Links') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
@section('scripts')
    ...
    <script type="text/javascript">
		...
		var table = $('#example').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('social.link.datatables') }}',
               columns: [
						{ data: 'name', name: 'name' },
                        { data: 'link', name: 'link' },
                        { data: 'icon', name: 'icon' },
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" data-href="{{route('social.link.create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
